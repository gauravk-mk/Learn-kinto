...
export default class Collection {
    ...
    constructor(client, bucket, name, options = {}) {
        ...
        // for doing the merge?
        this._headers = Object.assign({}, this.bucket._headers, options.headers);
    }
    /**
    ...
    async addAttachment(dataURI, record = {}, options = {}) {
        ...
        const { last_modified } = Object.assign({}, record, options);
    ...
    async deleteRecord(record, options = {}) {
        ...
        const { id } = recordObj;
        const { last_modified } = Object.assign({}, recordObj, options);
