...
function extractFileInfo(dataURL) {
    ...
    const binary = atob__default['default'](base64);
    const array = [];
...
function obscureAuthorizationHeader(headers) {
    const h = new nodeFetch.Headers(headers);
...
class HTTP {
    ...
    async request(url, request = { headers: {} }, options = { retry: 0 }) {
        ...
        if (request.body && request.body instanceof FormData__default['default']) {
            if (request.headers instanceof nodeFetch.Headers) {
...
class KintoClientBase {
    ...
    async execute(request, options = {}) {
        ...
        if (this._isBatch) {
            ...
            return raw
                ? { status: 0, json: msg, headers: new nodeFetch.Headers() }
                : msg;
        }
    ...
    async paginatedOperation(path, params = {}, options = {}) {
        ...
        const handleResponse = async function ({ headers = new nodeFetch.Headers(), json = {}, }) {
...
//# sourceMappingURL=kinto-http.node.js.map
